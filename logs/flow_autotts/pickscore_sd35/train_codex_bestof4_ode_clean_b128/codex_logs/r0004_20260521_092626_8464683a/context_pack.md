...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| r0003 | 0.000 | 10.000 | 0.819160 | 8.000 | 0.676477 | 0.142682 | deterministic forward (spawn=1.00, preview=0.00, nfe=10.00) |
| r0003 | 0.250 | 26.000 | 0.830756 | 24.000 | 0.816731 | 0.014025 | single-root preview (spawn=1.00, preview=6.00, nfe=26.00) |
| r0003 | 0.500 | 43.374 | 0.836467 | 44.000 | 0.842206 | -0.005739 | preview-guided backward refinement (spawn=1.00, preview=10.46, backward=1.00, prune=0.26, nfe=43.37) |
| r0003 | 0.750 | 65.068 | 0.840453 | 72.000 | 0.848101 | -0.007647 | preview-guided backward refinement (spawn=1.00, preview=15.95, backward=1.59, prune=0.01, nfe=65.07) |
| r0003 | 1.000 | 94.844 | 0.843201 | 100.000 | 0.849547 | -0.006347 | preview-guided backward refinement (spawn=1.00, preview=22.26, backward=2.38, prune=0.09, nfe=94.84) |
| r0002 | 0.000 | 10.000 | 0.819160 | 8.000 | 0.676477 | 0.142682 | deterministic forward (spawn=1.00, preview=0.00, nfe=10.00) |
| r0002 | 0.250 | 17.000 | 0.825253 | 24.000 | 0.816731 | 0.008522 | preview-guided backward refinement (spawn=1.00, preview=5.00, backward=1.00, nfe=17.00) |
| r0002 | 0.500 | 17.000 | 0.804678 | 24.000 | 0.816731 | -0.012053 | preview-guided backward refinement (spawn=1.00, preview=5.00, backward=1.00, nfe=17.00) |
| r0002 | 0.750 | 33.268 | 0.819591 | 24.000 | 0.816731 | 0.002860 | preview-guided backward refinement (spawn=1.00, preview=10.63, backward=2.63, prune=0.29, nfe=33.27) |
| r0002 | 1.000 | 64.740 | 0.823276 | 72.000 | 0.848101 | -0.024824 | preview-guided backward refinement (spawn=1.00, preview=21.24, backward=6.50, prune=0.31, nfe=64.74) |
...
### `logs/flow_autotts/pickscore_sd35/train_codex_bestof4_ode_clean_b128/history/r0003_20260521_092626_8464683a`

- controller snapshot: `logs/flow_autotts/pickscore_sd35/train_codex_bestof4_ode_clean_b128/history/r0003_20260521_092626_8464683a/flow_autotts/controllers/optimal.py`
- compact summary: `logs/flow_autotts/pickscore_sd35/train_codex_bestof4_ode_clean_b128/history/r0003_20260521_092626_8464683a/proposal_results/summary.json`
  ...
  "rounds": [
    {
      "beta_sweep": [
        ...
        },
        {
          ...
          "beta": 0.25,
          "nfe": 26,
          "reward": 0.8307563239336013,
          "reward_per_nfe": 0.031952166305138516
        },
        {
          "action_statistics": {
            "answer": 1.0,
          ...
          "behavior_summary": "preview-guided backward refinement (spawn=1.00, preview=10.46, backward=1.00, prune=0.26, nfe=43.37)",
          "beta": 0.5,
          "nfe": 43.374,
          "reward": 0.8364666754007339,
          "reward_per_nfe": 0.019314622921603068
        },
        {
          "action_statistics": {
            "answer": 1.0,
          ...
          "behavior_summary": "preview-guided backward refinement (spawn=1.00, preview=15.95, backward=1.59, prune=0.01, nfe=65.07)",
          "beta": 0.75,
          "nfe": 65.068,
          "reward": 0.8404532785415649,
          "reward_per_nfe": 0.013004546179389464
        },
        {
          "action_statistics": {
            "answer": 1.0,
          ...
          "behavior_summary": "preview-guided backward refinement (spawn=1.00, preview=22.26, backward=2.38, prune=0.09, nfe=94.84)",
          "beta": 1.0,
          "nfe": 94.844,
          "reward": 0.8432008126974105,
          "reward_per_nfe": 0.009069787800991259
        }
      ],
      "controller": "optimal",
...
### `logs/flow_autotts/pickscore_sd35/train_codex_bestof4_ode_clean_b128/history/r0002_20260521_092626_8464683a`

- controller snapshot: `logs/flow_autotts/pickscore_sd35/train_codex_bestof4_ode_clean_b128/history/r0002_20260521_092626_8464683a/flow_autotts/controllers/optimal.py`
- compact summary: `logs/flow_autotts/pickscore_sd35/train_codex_bestof4_ode_clean_b128/history/r0002_20260521_092626_8464683a/proposal_results/summary.json`
  ...
  "rounds": [
    {
      "beta_sweep": [
        ...
        },
        {
          ...
          "behavior_summary": "preview-guided backward refinement (spawn=1.00, preview=5.00, backward=1.00, nfe=17.00)",
          "beta": 0.25,
          "nfe": 17,
          "reward": 0.8252529221773147,
          "reward_per_nfe": 0.048544289539842043
        },
        {
          "action_statistics": {
            "answer": 1.0,
          ...
          "beta": 0.5,
          "nfe": 17,
          "reward": 0.8046779965162277,
          "reward_per_nfe": 0.04733399979507222
        },
        {
          "action_statistics": {
            "answer": 1.0,
          ...
          "behavior_summary": "preview-guided backward refinement (spawn=1.00, preview=10.63, backward=2.63, prune=0.29, nfe=33.27)",
          "beta": 0.75,
          "nfe": 33.268,
          "reward": 0.8195907310247421,
          "reward_per_nfe": 0.02466315340557519
        },
        {
          "action_statistics": {
            "answer": 1.0,
          ...
          "behavior_summary": "preview-guided backward refinement (spawn=1.00, preview=21.24, backward=6.50, prune=0.31, nfe=64.74)",
          "beta": 1.0,
          "nfe": 64.74,
          "reward": 0.823276465177536,
          "reward_per_nfe": 0.012736547544354299
        }
      ],
      "controller": "optimal",
      "controller_name": "OptimalController",
